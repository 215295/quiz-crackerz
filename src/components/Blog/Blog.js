        ...
        <div>
            <div className="card w-4/5 m-auto mt-10 bg-amber-600 shadow-xl rounded p-5  ">
                <div className="card-body">
                    <h2 className="card-title  text-2xl">1. What is purpose react router  ?</h2>
            ...
            <div className="card w-4/5 m-auto mt-10 bg-amber-600 shadow-xl rounded p-5">
                <div className="card-body">
                    <h2 className="card-title  text-2xl "> 2.How does context api work  ?</h2>
            ...
            <div className="card w-4/5 m-auto mb-10 mt-10 bg-amber-600 shadow-xl rounded p-5">
                <div className="card-body">
                    <h2 className="card-title  text-2xl"> 3. What is useHref  ?</h2>
